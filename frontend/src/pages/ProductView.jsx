        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="product" className="lg:w-1/2 w-[70%] md:w-full lg:h-auto aspect-h-9 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/51PL9oQ62BL._AC_SL1002_.jpg" />
